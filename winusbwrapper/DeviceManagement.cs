// Note: Everything that relates to System.Windows.Forms has been commented out. It does not belong in a library that should be able to run in other contexts e.g. from WPF.
