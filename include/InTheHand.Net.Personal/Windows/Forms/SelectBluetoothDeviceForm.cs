...
//
// NXTLib.Windows.Forms.SelectBluetoothDeviceDialogForm
// 
...
namespace NXTLib.Windows.Forms
{
    ...
    internal sealed class SelectBluetoothDeviceForm : System.Windows.Forms.Form, ISelectBluetoothDevice
    {
        ...
        public SelectBluetoothDeviceForm(/*BLUETOOTH_SELECT_DEVICE_PARAMS p*/)
        {
            ...
            switch (dpi)
            {
                case 96:
                    ...
                    imageList1.Images.Add(new Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("NXTLib.BluetoothWrapper.Windows.Forms.1f00.ico"),24,24));
                    break;
                case 128:
                    imageList1.ImageSize = new Size(32, 32);
                    imageList1.Images.Add(new Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("NXTLib.BluetoothWrapper.Windows.Forms.1f00.ico"), 32, 32));
                    break;
                case 131:
                    imageList1.ImageSize = new Size(32, 32);
                    imageList1.Images.Add(new Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("NXTLib.BluetoothWrapper.Windows.Forms.1f00.ico"), 32, 32));
                ...
                case 192:
                    ...
                    imageList1.Images.Add(new Icon(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("NXTLib.BluetoothWrapper.Windows.Forms.1f00.ico"), 48, 48));
                    break;
            }
#endif
        }
        ...
        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.ShowAuthenticated
        {
            get { return fShowAuthenticated; }
            set { fShowAuthenticated = value; }
        }

        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.ShowRemembered
        {
            get { return fShowRemembered; }
            set { fShowRemembered = value; }
        }

        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.ShowUnknown
        {
            get { return fShowUnknown; }
            set { fShowUnknown = value; }
        }

        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.ForceAuthentication
        {
            get { return fForceAuthentication; }
            set { fForceAuthentication = value; }
        }

        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.ShowDiscoverableOnly
        {
            get { return fDiscoverableOnly; }
            set { fDiscoverableOnly = value; }
        }

        string NXTLib.Windows.Forms.ISelectBluetoothDevice.Info
        {
            get { return info; }
            set { info = value; }
        }
        ...
        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.AddNewDeviceWizard
        {
            get { return false; }
            set { throw new NotImplementedException("The method or operation is not implemented."); }
        }

        bool NXTLib.Windows.Forms.ISelectBluetoothDevice.SkipServicesPage
        {
            get { return true; }
            set { throw new NotImplementedException("The method or operation is not implemented."); }
        }
        ...
        public void SetFilter(Predicate<NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo> filterFn,
