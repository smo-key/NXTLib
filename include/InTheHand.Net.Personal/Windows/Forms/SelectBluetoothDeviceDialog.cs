...
//
// NXTLib.Windows.Forms.SelectBluetoothDeviceDialog
// 
...
namespace NXTLib.Windows.Forms
{
    ...
    public class SelectBluetoothDeviceDialog : CommonDialog_or_Component
    {
        ...
        /// <summary>
        /// Obsolete, use <see cref="P:NXTLib.Windows.Forms.SelectBluetoothDeviceDialog.ShowDiscoverableOnly"/>
        /// instead.
        /// If TRUE, only devices which are currently discoverable are shown in the picker.
        /// </summary>
        /// <remarks>
        /// <para>Obsolete, use <see cref="P:NXTLib.Windows.Forms.SelectBluetoothDeviceDialog.ShowDiscoverableOnly"/>
        /// instead.
        /// </para>
        /// </remarks>
        /// <seealso cref="P:NXTLib.Windows.Forms.SelectBluetoothDeviceDialog.ShowDiscoverableOnly"/>
        ...
        /// information about each device is provided as a <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo"/>
        ...
        /// <example>
        ///     '......
        ///     Dim dlg As New NXTLib.Windows.Forms.SelectBluetoothDeviceDialog()
