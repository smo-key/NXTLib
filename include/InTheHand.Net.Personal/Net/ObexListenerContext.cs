...
//
// NXTLib.BluetoothWrapper.ObexListenerContext
// 
...
{
    /// <summary>
    /// Provides access to the request and response objects used by the <see cref="T:NXTLib.BluetoothWrapper.ObexListener"/> class.
    /// </summary>
    public class ObexListenerContext
    {
        ...
        internal ObexListenerContext(SocketAdapter s)
        {
            ...
            while (moretoreceive) {
                ...
                if (received == 3) {
                    ...
                    responsePacket = HandleAndMakeResponse(ref moretoreceive, ref putCompleted, received, method);
        ...
        private byte[] HandleAndMakeResponse(ref bool moretoreceive, ref bool putCompleted, int received, ObexMethod method)
        {
            byte[] responsePacket;
            switch (method) {
        ...
        /// <summary>
        /// Gets the <see cref="T:NXTLib.BluetoothWrapper.ObexListenerRequest"/> that represents a client's request for a resource
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="T:NXTLib.BluetoothWrapper.ObexListener.ObexListenerResponse"/> object that will be sent to the client in response to the client's request.
        /// </summary>
