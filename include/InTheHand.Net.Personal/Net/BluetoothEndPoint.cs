...
//
// NXTLib.BluetoothWrapper.BluetoothEndPoint
// 
...
namespace NXTLib.BluetoothWrapper
{
    ...
    /// </para>
    /// <para>When used for instance when connecting with <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothClient"/>, 
    ...
    /// the <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Service"/> property.
    /// </para>
    /// </remarks>
#if !NETCF
    [Serializable]
	...
	public class BluetoothEndPoint : EndPoint
	{
        ...
        /// -
        /// <remarks>
        /// <para>See the <see cref="T:NXTLib.BluetoothWrapper.BluetoothEndPoint"/> documentation for 
        ...
        /// <summary>
        /// Gets whether a <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Port"/> is set.
        /// </summary>
        public bool HasPort
        {
            get
        ...
        /// </summary>
        /// <remarks>Creates a copy including of the internal <see cref="T:NXTLib.BluetoothWrapper.BluetoothAddress"/>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks><see cref="F:NXTLib.BluetoothWrapper.BluetoothEndPoint.MinScn"/>
        /// </remarks>
