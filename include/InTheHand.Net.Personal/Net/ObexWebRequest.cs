...
//
// NXTLib.BluetoothWrapper.ObexWebRequest
// 
...
namespace NXTLib.BluetoothWrapper
{
    ...
    /// (see the documentation at the <see cref="P:NXTLib.BluetoothWrapper.ObexWebRequest.Method"/>
    /// property).
    ...
    public class ObexWebRequest : WebRequest
    {
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.ObexWebRequest.#ctor(System.Uri)"/>
        /// </param>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.ObexWebRequest.#ctor(System.String,NXTLib.BluetoothWrapper.BluetoothAddress,System.String)">
        ...
        /// supports GET.
        /// </para>
        /// <para>For a PUT sample see the <see cref="T:NXTLib.BluetoothWrapper.ObexWebRequest">class</see>
...
*/
                            ...
                            if (isWinCeSockets) {
                                ...
                                ns = new NXTLib.BluetoothWrapper.Bluetooth.Factory.TimeoutDecorStream(ns);
                            }
#endif
                            // Timeout
        ...
        private ObexStatusCode DoPut()
        {
            ...
            if (CheckResponse(ref status, false)) {
                ...
                while (totalBytes > 0) {
                    ...
                    BitConverter.GetBytes(IPAddress.HostToNetworkOrder(unchecked((short)(readBytes + 3)))).CopyTo(buffer, 4);

                    BitConverter.GetBytes(IPAddress.HostToNetworkOrder(unchecked((short)(readBytes + 6)))).CopyTo(buffer, 1);
        ...
        /// </summary>
        /// -
        /// <returns>An <see cref="T:NXTLib.BluetoothWrapper.ObexWebResponse"/>.</returns>
        /// -
