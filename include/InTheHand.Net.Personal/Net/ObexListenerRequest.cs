...
//
// NXTLib.BluetoothWrapper.ObexListenerRequest
// 
...
{
    /// <summary>
    /// Describes an incoming OBEX request to an <see cref="T:NXTLib.BluetoothWrapper.ObexListener"/> object.
    /// </summary>
    public class ObexListenerRequest
    {
        ...
        /// <remarks>For a complete list of request headers, see the <see cref="T:NXTLib.BluetoothWrapper.ObexHeader"/> enumeration.</remarks>
        ...
        /// subtype that matches the address family that the <see cref="T:NXTLib.BluetoothWrapper.ObexListener"/> 
        /// is listening on.  For instance if the listener was created with 
        /// <see cref="T:NXTLib.BluetoothWrapper.ObexTransport"/>.<see cref="F:NXTLib.BluetoothWrapper.ObexTransport.Bluetooth"/>
        /// then the <see cref="T:System.Net.EndPoint"/> will be of type
        /// <see cref="T:NXTLib.BluetoothWrapper.BluetoothEndPoint"/>, and similarly for 
        /// <see cref="T:NXTLib.BluetoothWrapper.IrDAEndPoint"/> and
        /// <see cref="T:System.Net.IPEndPoint"/>.
        /// </remarks>
        /// -
        /// <seealso cref="P:NXTLib.BluetoothWrapper.ObexListenerRequest.RemoteEndPoint"/>
        ...
        /// </example>
        /// -
        /// <seealso cref="P:NXTLib.BluetoothWrapper.ObexListenerRequest.LocalEndPoint"/>
