...
//
// NXTLib.BluetoothWrapper.ObexListener
// 
    ...
    public class ObexListener
    {
        ...
        private static ServiceRecord CreateServiceRecord()
        {
            ...
            ServiceRecord record = new ServiceRecord(
                new ServiceAttribute(NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ServiceClassIdList,
                    new ServiceElement(ElementType.ElementSequence,
                        new ServiceElement(ElementType.Uuid16, (UInt16)0x1105))),
                new ServiceAttribute(NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList,
                ...
                new ServiceAttribute(NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.LanguageBaseAttributeIdList,
                    englishUtf8PrimaryLanguage),
                new ServiceAttribute(ServiceRecord.CreateLanguageBasedAttributeId(
                        NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProviderName,
                        LanguageBaseItem.PrimaryLanguageBaseAttributeId),
                    new ServiceElement(ElementType.TextString, "32feet.NET")),
#endif
                //
                new ServiceAttribute(NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.ObexAttributeId.SupportedFormatsList,
                    new ServiceElement(ElementType.ElementSequence,
        ...
        /// On Bluetooth this uses <see cref="P:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Authenticate">BluetoothListener.Authenticate</see>.
        /// </para>
        /// </remarks>
        ...
        /// <remarks>
        /// <para>Only Bluetooth supports this, TCP/IP and IrDA do not.
        /// On Bluetooth this uses <see cref="P:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Encrypt">BluetoothListener.Encrypt</see>.
        /// </para>
        /// </remarks>
        public bool Encrypt
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the <see cref="T:NXTLib.BluetoothWrapper.ObexListener"/> has been started.
        /// </summary>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.ObexListener.Stop"/>/<see cref="M:NXTLib.BluetoothWrapper.ObexListener.Close"/>
        /// has been called.
        /// </para>
        /// </remarks>
        /// -
        /// <returns>Returns a <see cref="T:NXTLib.BluetoothWrapper.ObexListenerContext"/>
