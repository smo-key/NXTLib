...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// using classes: <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioInRangeEventArgs"/>
    /// and <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioOutOfRangeEventArgs"/>.
    ...
    /// the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioInRangeEventArgs"/>
    /// class via properties:
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioInRangeEventArgs.CurrentState"/>
    /// and <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioInRangeEventArgs.PreviousState"/>,
    /// and also <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioInRangeEventArgs.GainedStates"/> etc.
    /// </para>
    /// <para>To see the events get an instance of this class via its method
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Events.GetInstance"/>.
    ...
    public class BluetoothWin32Events : IDisposable
    {
        ...
        /// -
        /// <remarks>
        /// <para>Consider using the method <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Events.GetInstance"/>
        ...
        /// <summary>
        /// Raises the <see cref="E:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Events.InRange"/> event.
        /// </summary>
        /// -
        /// <param name="e">A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioInRangeEventArgs"/>
        ...
        /// <summary>
        /// Raises the <see cref="E:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Events.OutOfRange"/> event.
        /// </summary>
        /// -
        /// <param name="e">A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32RadioOutOfRangeEventArgs"/>
        /// that contains the event data.
        /// </param>
