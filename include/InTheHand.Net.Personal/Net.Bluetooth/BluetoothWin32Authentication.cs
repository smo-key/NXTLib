...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothClient"/> to support
    /// its <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothClient.SetPin(System.String)"/> method).
    /// </para>
    ...
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs"/>.
    ...
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs.AuthenticationMethod"/>
    /// property.
    /// If it is <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothAuthenticationMethod.Legacy"/>
    /// then the callback method should set the
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs.Pin"/>
    /// property.
    /// </para>
    /// <para>
    /// For the other authentication methods 
    /// e.g. <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothAuthenticationMethod.NumericComparison"/>
    /// or <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothAuthenticationMethod.OutOfBand"/>
    ...
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs.Confirm"/>,
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs.ResponseNumberOrPasskey"/>,
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs.ConfirmOob(System.Byte[],System.Byte[])"/>
    /// etc.
    /// </para>
    /// <para>
    ...
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Authentication.Dispose"/>
    ...
    /// ...
    /// 
    /// Sub Win32AuthCallbackHandler(ByVal sender As Object, ByVal e As NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs)
    ...
    public partial class BluetoothWin32Authentication : IDisposable
    {
        ...
        /// </summary>
        /// <remarks><see cref="P:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs.PreviousNativeErrorCode"/>
        /// </remarks>
        ...
        /// <overloads>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Authentication"/> class.
        /// </overloads>
        /// -
        /// <summary>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Authentication"/> class,
        ...
        /// as a <see cref="T:NXTLib.BluetoothWrapper.BluetoothAddress"/>.
        /// </param>
        ...
        /// </summary>
        /// -
        /// <param name="e">An instance of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32AuthenticationEventArgs"/> 
        ...
        /// <summary>
        /// Release the unmanaged resources used by the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothWin32Authentication"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
