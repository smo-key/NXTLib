...
//
// NXTLib.BluetoothWrapper.Bluetooth.Msft.WindowsBluetoothListener
// 
...
namespace NXTLib.BluetoothWrapper.Bluetooth.Msft
{
	...
	class WindowsBluetoothListener : IBluetoothListener
	{
        ...
        /// <remarks>
        /// <para>
        /// An SDP record is published on successful <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.Start"/>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(System.Guid,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>,
        /// or when passing it as a byte array 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(System.Guid,System.Byte[],System.Int32)"/>.
        /// The format of the generic record used here is shown there also.
        /// </para><para>
        /// Call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.Start"/> 
        ...
        /// If a SDP record with more elements is required, then use
        /// one of the other constructors that takes an SDP record e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothAddress,System.Guid,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>,
        /// or when passing it as a byte array, e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothAddress,System.Guid,System.Byte[],System.Int32)"/>.
        /// The format of the generic record used here is shown there also.
        /// </para><para>
        /// Call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.Start"/> 
        /// method to begin listening for incoming connection attempts.
        ...
        /// If a SDP record with more elements is required, then use
        /// one of the other constructors that takes an SDP record e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothEndPoint,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>,
        /// or when passing it as a byte array
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothEndPoint,System.Byte[],System.Int32)"/>.
        /// The format of the generic record used here is shown there also.
        /// </para><para>
        /// Call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.Start"/> 
        /// method to begin listening for incoming connection attempts.
        ...
        /// e.g. <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(System.Guid)"/>
        ...
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.Start"/>,
        ...
        /// standard profiles.  Otherwise use one of the other constructors 
        /// e.g. <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothAddress,System.Guid)"/>
        /// which create a generic SDP Record from the specified service identifier.
        /// </note>
        /// <para>Instead of passing a byte array containing a hand-built record,
        /// the record can also be built using the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        ...
        /// standard profiles.  Otherwise use one of the other constructors 
        /// e.g. <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothEndPoint)"/>
        /// which create a generic SDP Record from the specified service identifier.
        /// </note>
        /// <para>Instead of passing a byte array containing a hand-built record,
        /// the record can also be built using the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.WindowsBluetoothListener.Start"/>ed
