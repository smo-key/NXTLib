...
//
// NXTLib.BluetoothWrapper.Bluetooth.Msft.BluetoothDeviceInfo
// 
...
using AsyncResult_BeginGetServiceRecords = NXTLib.BluetoothWrapper.AsyncResult<NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord[], System.Guid>;
...
namespace NXTLib.BluetoothWrapper.Bluetooth.Msft
{
    ...
    class WindowsBluetoothDeviceInfo : IBluetoothDeviceInfo
    {
        ...
        /// -
        /// <remarks>
        /// See <see cref="P:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.DeviceName"/>
        ...
        /// having called <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.Refresh"/>
        /// in the meantime.
        /// </para>
        /// </remarks>
        ...
        /// if required
        /// (<see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.SetServiceState(System.Guid,System.Boolean,System.Boolean)"/>).
        /// </para>
        /// </remarks>
        /// -
        ...
        public void SetServiceState(Guid service, bool state, bool throwOnError)
        {
            ...
            if (service == BluetoothService.SerialPort)
            {
                if (state)
                {
                    ...
                    //try open port now
                    try {
                        NXTLib.BluetoothWrapper.Ports.BluetoothSerialPort.CreateClient(availablePorts[availablePorts.Count - 1], new BluetoothEndPoint(this.DeviceAddress, BluetoothService.SerialPort));
                    } catch (Exception ex) {
        ...
        /// search for UUID <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothService.SerialPort"/>,
        /// or too find all the services that use RFCOMM use 
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothService.RFCommProtocol"/>,
        /// or all the services use 
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothService.L2CapProtocol"/>.
        /// </para>
        /// <para>
        ...
        public byte[][] GetServiceRecordsUnparsedWindowsRaw(Guid service)
        {
            ...
            while (lookupresult == 0) {
                ...
                if (lookupresult == -1) {
                    ...
                    IntPtr pBlob = NXTLib.Runtime.InteropServices.Marshal32.ReadIntPtr(sdpBuffer, WqsOffset.lpBlob_56);
                    if (pBlob != IntPtr.Zero) {
                        IntPtr pSdpBlob = NXTLib.Runtime.InteropServices.Marshal32.ReadIntPtr(pBlob, BlobOffsets.Offset_pBlobData_4);
        ...
        /// <see cref="P:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.Authenticated"/>.
        /// </remarks>
        ...
        public void SetDiscoveryTime(DateTime dt)
        {
            ...
            m_lastSeen = dt;
#else
            deviceInfo.stLastSeen = NXTLib.Win32.SYSTEMTIME.FromDateTime(dt);
#endif
        }
        #endregion
        ...
        private void ReadVersionsInfo()
        {
            ...
            if (!success) {
                ...
                Debug.WriteLine(string.Format(CultureInfo.InvariantCulture,
                    ...
                    (NXTLib.Win32.Win32Error)gle, gle));
