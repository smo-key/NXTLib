...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    /// are returned as <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/> instances.
    /// </para>
    ...
    public class L2CapListener
    {
...
#elif BlueZ
                m_impl = new NXTLib.BluetoothWrapper.Bluetooth.BlueZ.BluezL2CapListener(null);
#endif
            } else {
                m_impl = NXTLib.BluetoothWrapper.Bluetooth.Widcomm.WidcommL2CapListener.Create();
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapListener"/> class
        /// that listens on the specified service identifier.
        /// </summary>
        /// -
        /// <param name="service">The Bluetooth service to listen on.
        /// Either one of the values on <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothService"/>,
        ...
        /// -
        /// <remarks>
        /// <para>The simpler constructor <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapListener.#ctor(System.Guid)"/>
        ...
        /// is similarly set, or is <see cref="F:NXTLib.BluetoothWrapper.BluetoothAddress.None">BluetoothAddress.None</see> 
        /// if not known.
        /// The endpoint&#x2019;s <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Service"/>
        /// is never set.
        /// </para>
        /// </remarks>
        ...
        /// a new <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/> to handle remote host communication.
        /// </summary>
        /// -
        ...
        /// </param>
        /// -
        /// <returns>A <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/>.
        /// </returns>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/> that you can use to send and receive data.
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/>.
        /// The <see cref="System.IO.Stream"/> will provide you with methods for
        /// sending and receiving with the remote host.
        /// When you are through with the <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/>, be sure
        /// to call its <see cref="L2CapClient.Close"/> method.
        /// </para>
        /// </remarks>
        /// -
        /// <returns>A <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/> used to send and receive data.</returns>
        /// -
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapListener.Start"/>ed
