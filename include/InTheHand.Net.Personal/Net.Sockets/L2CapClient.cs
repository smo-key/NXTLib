...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    /// -
    /// <remarks>
    /// <para>For RFCOMM connections use <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothClient"/>.
    /// </para>
    /// <para>The normal usage is o create an instance, connect with 
    /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.Connect(NXTLib.BluetoothWrapper.BluetoothEndPoint)"/>
    /// or <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.BeginConnect(NXTLib.BluetoothWrapper.BluetoothEndPoint,System.AsyncCallback,System.Object)"/>,
    /// and if successful one then calls <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.GetStream"/>
    /// to send and receive data.
    /// </para>
    /// <para>See the <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.Connect(NXTLib.BluetoothWrapper.BluetoothEndPoint)"/>
    ...
    public class L2CapClient
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/>.
        /// </summary>
        public L2CapClient()
        //    : this(BluetoothFactory.Factory)
        {
            ...
            //#elif BlueZ
            //                m_impl = new NXTLib.BluetoothWrapper.Bluetooth.BlueZ.BluezL2CapClient(null);
            //#endif
            //            } else {
            //                m_impl = NXTLib.BluetoothWrapper.Bluetooth.Widcomm.WidcommL2CapClient.Create();
            //            }
        }
        ...
        #region Close
        /// <summary>
        /// Closes the <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/> and the underlying connection.
        /// </summary>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.Dispose"/>
        [DebuggerStepThrough]
        public void Close()
        {
            Dispose();
        ...
        /// </summary>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.Close"/>
        [DebuggerStepThrough]
        public void Dispose()
        {
            m_impl.Dispose();
        ...
        /// -
        /// <remarks>
        /// <para>The <see cref="T:NXTLib.BluetoothWrapper.BluetoothEndPoint"/> must
        /// have the <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Address"/>
        /// set, and either the <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Service"/>
        /// or <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Port"/> properties
        /// set.
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapListener"/> for more
        /// information.
        /// </para>
        /// </remarks>
        /// -
        /// <param name="remoteEP">The <see cref="T:NXTLib.BluetoothWrapper.BluetoothEndPoint"/>
        ...
        /// See 
        /// or <see cref="M:NXTLib.BluetoothWrapper.Sockets.L2CapClient.Connect(NXTLib.BluetoothWrapper.BluetoothEndPoint)"/>,
        /// for more information.
        /// </param>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.L2CapClient"/> is communicating.
        /// </value>
