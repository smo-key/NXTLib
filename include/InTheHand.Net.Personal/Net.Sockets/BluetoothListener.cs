...
//
// NXTLib.BluetoothWrapper.Sockets.BluetoothListener
// 
...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder"/>.
    /// </para>
    /// <para>There are overloads of the constructor which take a 
    /// <see cref="T:NXTLib.BluetoothWrapper.BluetoothEndPoint"/> parameter instead of a 
	...
	public class BluetoothListener
	{
        ...
        /// <remarks>
        /// <para>
        /// An SDP record is published on successful <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Start"/>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(System.Guid,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>,
        /// or when passing it as a byte array 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(System.Guid,System.Byte[],System.Int32)"/>.
        /// The format of the generic record used here is shown there also.
        /// </para><para>
        /// Call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Start"/> 
        ...
        /// If a SDP record with more elements is required, then use
        /// one of the other constructors that takes an SDP record e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothAddress,System.Guid,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>,
        /// or when passing it as a byte array, e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothAddress,System.Guid,System.Byte[],System.Int32)"/>.
        /// The format of the generic record used here is shown there also.
        /// </para><para>
        /// Call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Start"/> 
        /// method to begin listening for incoming connection attempts.
        ...
        /// If a SDP record with more elements is required, then use
        /// one of the other constructors that takes an SDP record e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothEndPoint,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>,
        /// or when passing it as a byte array
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothEndPoint,System.Byte[],System.Int32)"/>.
        /// The format of the generic record used here is shown there also.
        /// </para><para>
        /// Call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Start"/> 
        /// method to begin listening for incoming connection attempts.
        ...
        /// However the supplied record is now parsed into an <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        ...
        /// e.g. <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(System.Guid)"/>
        ...
        /// the record can also be built using the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        /// and <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/> classes, and
        ...
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Start"/>,
        ...
        /// standard profiles.  Otherwise use one of the other constructors 
        /// e.g. <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothAddress,System.Guid)"/>
        /// which create a generic SDP Record from the specified service identifier.
        /// </note>
        /// <para>Instead of passing a byte array containing a hand-built record,
        /// the record can also be built using the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        ...
        /// standard profiles.  Otherwise use one of the other constructors 
        /// e.g. <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.#ctor(NXTLib.BluetoothWrapper.BluetoothEndPoint)"/>
        /// which create a generic SDP Record from the specified service identifier.
        /// </note>
        /// <para>Instead of passing a byte array containing a hand-built record,
        /// the record can also be built using the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        ...
        ///             NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ServiceClassIdList,
        ///             classList),
        ///         new ServiceAttribute(
        ///             NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList,
        ///             pdl));
        ///     return record;
        /// }
        /// </code>
        ...
        /// </summary>
        /// -
        /// <value>The <see cref="T:NXTLib.BluetoothWrapper.BluetoothEndPoint"/>
        /// that the listener is using for communications.
        /// </value>
        /// -
        /// <remarks>
        /// <para>The <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Port"/> 
        /// property of the endpoint will contain the port number (RFCOMM Channel 
        /// Number) that the listener is listening on.
        /// On some platforms, the <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Address"/>
        /// is similarly set, or is <see cref="F:NXTLib.BluetoothWrapper.BluetoothAddress.None"/> 
        /// if not known.  The endpoint&#x2019;s <see cref="P:NXTLib.BluetoothWrapper.BluetoothEndPoint.Service"/>
        /// is never set.
        /// </para>
        /// </remarks>
        ...
        /// e.g. <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ServiceClass.ObjectTransfer"/>,
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ServiceClass.Telephony"/>,
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ServiceClass.Audio"/> etc.
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothListener.Start"/>ed
