...
//
// NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo
// 
...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    public class BluetoothDeviceInfo : IComparable
    {
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo"/> class 
        /// for the device with the given address.
        /// </summary>
        /// -
        /// <param name="address">The <see cref="T:NXTLib.BluetoothWrapper.BluetoothAddress"/>.</param>
        ...
        /// perhaps it could call <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.GetServiceRecords(System.Guid)"/>
        ...
        /// </summary>
        /// -
        /// <param name="service">See <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.GetServiceRecords(System.Guid)"/>.
        /// </param>
        ...
        /// returns the current time, see <see cref="P:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.LastSeen"/>.
        /// </para>
        /// </remarks>
        /// -
        /// <value>
