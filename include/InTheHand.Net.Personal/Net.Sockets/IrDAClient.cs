...
//
// NXTLib.BluetoothWrapper.Sockets.IrDAClient
// 
...
using System.Text;
using NXTLib.BluetoothWrapper.IrDA;
...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    /// cref="F:NXTLib.BluetoothWrapper.Sockets.IrDASocketOptionName.NineWireMode"/>.
    /// </para>
    ...
    /// client and server, see <see cref="T:NXTLib.BluetoothWrapper.ObexWebRequest"/> etc.
    /// </para>
    /// </remarks>
    /// -
    ...
    /// </example>
    /// -
    /// <seealso cref="N:NXTLib.BluetoothWrapper.Sockets"/>
    ...
    public class IrDAClient : IDisposable
	{
        ...
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.DiscoverDevices"/>, then a 
        /// connection can be made to the  required service on the chosen peer using <see 
        /// cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(NXTLib.BluetoothWrapper.IrDAEndPoint)"/>.
        /// Or, given just the  service name a connection will be made to an arbitrary 
        /// peer, using <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(System.String)"/>.  This is 
        /// most useful when it is expected that there will be only one device in 
        /// range &#x2014; as is often the case.</para>
        /// </remarks>
		public IrDAClient()
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Sockets.IrDAClient"/> 
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(System.String)"/>.      
        /// </para>
        /// <para>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.#ctor(NXTLib.BluetoothWrapper.IrDAEndPoint)"/>
        /// overload.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// See <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(System.String)"/> 
        ...
        /// This is 
        /// equivalent to calling the default constructor followed by 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(NXTLib.BluetoothWrapper.IrDAEndPoint)"/>.
        /// </para>
        /// <para>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.#ctor(System.String)"/> instead.
        /// </para>
        /// </remarks>
        /// <param name="remoteEP">
        ...
        /// <see cref="F:NXTLib.BluetoothWrapper.Sockets.IrDASocketOptionName.NineWireMode"/>.
        /// </remarks>
        /// <example>Example code to connect to a IrCOMM service would be as 
        ...
        /// </remarks>
        /// -
        /// <returns>The discovered devices as an array of <see cref="T:NXTLib.BluetoothWrapper.Sockets.IrDADeviceInfo"/>.</returns>
        ...
        /// to connect to.  If only one device is expected to be in range, or 
        /// an arbitrary peer device is suitable, then one can use 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(System.String)"/> instead.
        /// </para>
        /// </remarks>
        /// <param name="remoteEP">
        /// An <see cref="IrDAEndPoint"/> initialised with the address of the peer
        ...
        /// by a call to <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.BeginConnect(NXTLib.BluetoothWrapper.IrDAEndPoint,System.AsyncCallback,System.Object)"/>
        /// / <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.BeginConnect(System.String,System.AsyncCallback,System.Object)"/>.
        /// </param>
        ...
        /// </para>
        /// <para>You must call the <see cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Connect(NXTLib.BluetoothWrapper.IrDAEndPoint)"/> 
        ...
        /// </summary>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Sockets.IrDAClient.Close"/>
        public void Dispose()
        {
            Dispose(true);
