...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    /// interace to another connection type e.g. a <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothClient"/>
    /// </summary>
    /// -
    /// <remarks>
    /// <para>See class <see cref="T:NXTLib.BluetoothWrapper.Sockets.SocketClientAdapter"/>
    /// for an implementation that adapts <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothClient"/>
    /// etc to the <see cref="T:System.Net.Sockets.Socket">Socket</see>-like interface.
    /// That is required as on Widcomm/Broadcom <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothClient"/>
