...
namespace NXTLib.BluetoothWrapper.Bluetooth.AttributeIds
{
    ...
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothService.PnPInformation"/>.
    /// </para>
    /// <para>As well as the attributes defined here, use of some of the universal
    /// attributes is recommended, they are:
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ClientExecutableUrl"/>,
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ServiceDescription"/>,
    /// and <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.DocumentationUrl"/>.
    /// </para>
    /// </remarks>
    public static class DeviceIdProfileAttributeId
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para>The id assigned by the organisation in <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.DeviceIdProfileAttributeId.VendorIdSource" />. [<c>UInt16</c>]
        /// </para>
