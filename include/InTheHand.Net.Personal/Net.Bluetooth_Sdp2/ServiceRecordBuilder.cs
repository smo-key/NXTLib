using System;
using NXTLib.BluetoothWrapper.Bluetooth.AttributeIds;
#if V1
using List_ServiceElement = System.Collections.ArrayList;
using List_ServiceAttribute = System.Collections.ArrayList;
#else
using List_ServiceElement = System.Collections.Generic.List<NXTLib.BluetoothWrapper.Bluetooth.ServiceElement>;
using List_ServiceAttribute = System.Collections.Generic.List<NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute>;
#endif
...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// <summary>
    /// Provides a simple way to build a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>, 
    /// including ServiceClassIds and ServiceNames attributes etc.
    /// </summary>
    /// -
    /// <remarks>
    /// <para>The service&#x2019;s Class Id can be set with the 
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder.AddServiceClass(System.Guid)"/>/<see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder.AddServiceClass(System.UInt16)"/>/etc
    /// methods, the protocol stack set with the <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder.ProtocolType"/>
    /// property (default RFCOMM), and the Service Name set with the 
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder.ServiceName"/>
    ...
    public class ServiceRecordBuilder
    {
        ...
        /// <summary>
        /// Create a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> instance 
        /// constructed by the specified <see cref="ServiceRecordBuilder"/> instance.
        /// </summary>
        /// -
        /// <value>
        /// A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> that contains 
        /// the URI constructed by the <see cref="ServiceRecordBuilder"/> .
        /// </value>
        /// -
        /// <exception cref="T:System.InvalidOperationException">The <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> 
...
#warning Hey Hey Hey Hey Hey Hey Hey Hey Hey Hey
        ...
        /// <summary>
        /// Get or set a value for the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ServiceName"/> 
        /// attribute.
        /// </summary>
        /// -
        /// <remarks><para>When present, a corresponding <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.LanguageBaseAttributeIdList"/> 
        ...
        /// <summary>
        /// Get or set a value for the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProviderName"/> 
        /// attribute.
        /// </summary>
        /// -
        /// <remarks><para>When present, a corresponding <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.LanguageBaseAttributeIdList"/> 
        ...
        /// <summary>
        /// Get or set a value for the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ServiceDescription"/> 
        /// attribute.
        /// </summary>
        /// -
        /// <remarks><para>When present, a corresponding <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.LanguageBaseAttributeIdList"/> 
        ...
        /// <summary>
        /// Get or set which type of element will be added for the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList"/> 
        /// attribute.
        /// </summary>
        /// -
        /// <value>An instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.BluetoothProtocolDescriptorType"/> 
        /// enumeration.
        /// </value>
        /// -
        ...
        /// </item>
        /// </list>
        /// <para>The default is <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.BluetoothProtocolDescriptorType.Rfcomm"/>.
        /// </para>
        /// </remarks>
        ...
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ServiceClassIdList"/>
        ...
        /// <summary>
        /// Add a <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.BluetoothProfileDescriptorList"/> 
        /// element.
        /// </summary>
        /// -
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> instances.
        /// </param>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>.
        /// </param>
        ...
        /// -
        /// <summary>
        /// Add a custom attribute from a given <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>
        /// </summary>
        /// -
        /// <param name="serviceAttribute">An attribute as a 
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> instance.
        /// </param>
        ...
        /// <param name="elementType">The type of the element as an <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementType"/>.</param>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder"/> instance.
        /// </summary>
        /// -
        /// <remarks>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.BluetoothListener"/> you must take 
        ...
        /// </param>
        /// -
        /// <returns>A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordBuilder"/> 
