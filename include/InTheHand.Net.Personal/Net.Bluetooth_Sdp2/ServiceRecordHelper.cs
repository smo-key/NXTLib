...
using IEnumerator_ServiceElement = System.Collections.Generic.IEnumerator<NXTLib.BluetoothWrapper.Bluetooth.ServiceElement>;
#else
...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// <summary>
    /// Some useful methods for working with a SDP <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
    /// including creating and accessing the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList"/>
 ...
 class ServiceRecordHelper
    {
        ...
        /// </summary>
        /// -
        /// <param name="record">The <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>
        /// to search for the element.
        /// </param>
        /// -
        /// <returns>The <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>
        /// holding the Channel Number.
        /// or <see langword="null"/> if at the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList"/>
 ...
 out bool? isSimpleRfcomm
        ...
        /// or -1 if at the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList"/>
        /// attribute is missing or contains invalid elements.
        /// </returns>
        ...
        /// </summary>
        /// -
        /// <returns>The new <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>.</returns>
        /// -
