...
#else
using IList_ServiceAttribute = System.Collections.Generic.IList<NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute>;
using IList_ServiceAttributeId = System.Collections.Generic.IList<NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId>;
using IEnumerable_ServiceAttribute = System.Collections.Generic.IEnumerable<NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute>;
using IEnumerator_ServiceAttribute = System.Collections.Generic.IEnumerator<NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute>;
#endif
using System.Text;
...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// by a numerical identifier (its <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId"/>),
    /// and with its data held in a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>.
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/> has methods to access the
    ...
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.ObexAttributeId"/>,
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.BasicPrintingProfileAttributeId"/>,
    /// etc. The Service Discovery profile itself defines IDs, some that can be used 
    /// in any record <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId"/>, 
    /// and others
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.ServiceDiscoveryServerAttributeId"/>,
    /// and <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.BrowseGroupDescriptorAttributeId"/>.
    /// </para>
    ...
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.ServiceDiscoveryServerAttributeId.VersionNumberList"/>
    /// and <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.BrowseGroupDescriptorAttributeId.GroupId"/>
    /// from <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.ServiceDiscoveryServerAttributeId"/>
    /// and <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.BrowseGroupDescriptorAttributeId"/>
    /// respectively.
    /// </para>
    /// <para><see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> provides the normal 
    /// collection-type methods properties e.g. 
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.Count"/>, 
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.Contains(NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId)"/>,
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetAttributeById(NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId)"/>,
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.Item(System.Int32)"/>
    /// and <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetEnumerator"/>.  So, to 
    /// access a particular attribute&#x2019;s content get the 
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> using one of those methods 
    /// and then read the data from the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>. 
    ...
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsString(NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem)"/>,
    /// which takes a multi-language-base item from the same record (see e.g.
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetPrimaryLanguageBaseItem"/>),
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsString(System.Text.Encoding)"/>
    /// which takes a .NET <see cref="T:System.Text.Encoding"/> object,
    /// or <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsStringUtf8"/>,
    /// or <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetMultiLanguageStringAttributeById(NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId,NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem)"/>
    ...
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.CreateServiceRecordFromBytes(System.Byte[])"/>
    /// method or the 
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser.Parse(System.Byte[],System.Int32,System.Int32)"/>
    /// on <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser"/>.  A record
    /// can also be created from a list of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>
    /// passed to the constructor 
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.#ctor(System.Collections.Generic.IList{NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute})"/>.
    /// </para>
    /// 
    /// <para>&#xA0;
    /// </para>
    ...
    public sealed class ServiceRecord : IEnumerable_ServiceAttribute
    {
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> class 
        /// containing no <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>s.
        /// </summary>
        ...
        /// Initializes a new instance of the 
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> class 
        /// with the specified set of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>s.
        /// </summary>
        /// -
        /// <param name="attributesList">The list of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>
        /// to add to the record,
        /// as an <see cref="T:System.Collections.Generic.IList`1"/>
        /// of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>.
        /// </param>
        ...
        /// <param name="attributesList">The list of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>
        /// to add to the record,
        /// as an array of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>.
        /// </param>
        ...
        /// <summary>
        /// Create a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> by parsing
        /// the given array of <see cref="T:System.Byte"/>.
        /// </summary>
        /// -
        /// <remarks>This uses the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser"/>
        /// with its default settings.
        /// See <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser.Parse(System.Byte[],System.Int32,System.Int32)"/>
        ...
        /// </exception>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser.Parse(System.Byte[],System.Int32,System.Int32)"/>
        ...
        /// -
        /// <returns>A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> holding 
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId"/>.</param>
        /// -
        ...
        /// </summary>
        /// -
        /// <param name="id">The Attribute Id as a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId"/>.</param>
        /// -
        /// <returns>A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> holding 
        ...
        /// as an <see cref="T:System.Collections.Generic.IList`1"/>
        /// of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId"/>.
        /// </summary>
        /// -
        /// <remarks>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>'s
        ...
        /// </summary>
        /// -
        /// <returns>The result <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId"/>.</returns>
        /// -
        ...
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor.TextString"/>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetPrimaryMultiLanguageStringAttributeById(NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId)"/> 
        ...
        /// specified in the given <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem"/>.
        /// </exception>
        /// -
        /// <example>
        /// C#:
        ...
        /// -
        /// <remarks>
        /// See also <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetPrimaryLanguageBaseItem"/>.
        /// </remarks>
        /// -
        /// <returns>
        /// An array of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem"/>.
        /// An array of length zero is returned if the service record contains no such attribute.
        /// </returns>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetPrimaryLanguageBaseItem"/>
        public LanguageBaseItem[] GetLanguageBaseList()
        {
            if (!Contains(NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.LanguageBaseAttributeIdList)) {
                return new LanguageBaseItem[0];
            }
            ServiceAttribute attr = GetAttributeById(NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.LanguageBaseAttributeIdList);
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetMultiLanguageStringAttributeById(NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId,NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem)"/>,
        /// and <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetAttributeById(NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId,NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem)"/>
        /// etc.  See example code in the first.
        /// </remarks>
        /// -
        /// <returns>
        /// A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.LanguageBaseItem"/>, or null
        /// if the service record contains no such attribute, or 
        /// no primary language item (one with Base Id 0x0100) is included.
        /// </returns>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord.GetLanguageBaseList"/>
#if CODE_ANALYSIS
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate")]
#endif
        ...
        /// list of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>s.
        /// </summary>
        /// -
        /// <returns>An <see cref="T:System.Collections.Generic.IEnumerator`1"/>
        /// of type <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>.
        /// </returns>
        /// -
        /// <example>
        /// In C#:
        ...
        /// -
        /// <remarks>
        /// <para>A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> can be created either by manually building new 
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>s holding new 
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>s, or it can be created
        /// by <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser"/> parsing an array
        /// of bytes read from another machine by e.g. 
        /// <see cref="M:NXTLib.BluetoothWrapper.Sockets.BluetoothDeviceInfo.GetServiceRecords(System.Guid)"/>.
        /// In that case this method returns that source byte array.
        /// </para>
        /// <para>To creates a Service Record byte array from the contained
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/>s use
        /// <see cref="ToByteArray"/> or <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordCreator"/>.
        /// </para>
        /// </remarks>
        /// -
        /// <value>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> instance using
        /// the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordCreator"/> class.
        /// </remarks>
        /// -
