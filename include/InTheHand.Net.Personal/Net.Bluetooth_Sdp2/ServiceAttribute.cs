...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.Value"/> property and read the 
    ...
    public sealed class ServiceAttribute
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> class.
        /// </summary>
        /// -
        /// <param name="id">The Attribute Id as a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttributeId"/>.</param>
        /// <param name="value">The value as a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>.</param>
        ...
        /// <summary>
        /// Get the value of this attributes as a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>
        /// </summary>
