...
#pragma warning disable 1591
    ...
    */
    ...
    /// types are listed in enum <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementType"/>.
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// (Is a logical combination of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor"/>
    /// field which defines the major type and the size field in the binary format; and
    /// the size field being made up of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.SizeIndex"/>
    /// field and any additional length bytes.
    /// </para>
    /// <para>Note, the values here are not the numerical bitwise combination of the 
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor"/> and 
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.SizeIndex"/> fields as they appear 
