...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// <summary>
    /// Utilities method working on SDP <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/>s, for instance to
    ...
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.BluetoothService.GetName(System.Guid)"/>/etc and
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.MapServiceClassToAttributeIdList"/>
    /// respectively.
    /// </remarks>
    public
#if ! V1
 ...
 class ServiceRecordUtilities
    {
        ...
        */
        ...
        /// </summary>
        /// -
        /// <param name="record">A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> to be dumped.</param>
        /// <returns>A <see cref="T:System.String"/> containing the 'dump' text.</returns>
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordUtilities.DumpRaw(System.IO.TextWriter,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>
        ...
        /// <param name="record">A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> to be dumped.</param>
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordUtilities.DumpRaw(NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord)"/>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordUtilities.Dump(System.IO.TextWriter,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord,System.Type[])"/> 
        /// overload for more information.
        /// </param>
        /// -
        /// <returns>A <see cref="T:System.String"/> containing the 'dump' text.</returns>
        /// -
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordUtilities.Dump(System.IO.TextWriter,NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord,System.Type[])"/>
        ...
        /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.MapServiceClassToAttributeIdList"/> class,
        ...
        /// for the attributes contained in this record.  See the 
        /// </param>
        /// <seealso cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordUtilities.Dump(NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord,System.Type[])"/>
        ...
        /// </param>
        /// -
        /// <returns>The id as a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordUtilities.HackProtocolId"/>.
