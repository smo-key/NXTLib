...
#else
using IList_ServiceElement = System.Collections.Generic.IList<NXTLib.BluetoothWrapper.Bluetooth.ServiceElement>;
...
namespace NXTLib.BluetoothWrapper.Bluetooth
{
    ...
    /// environments.  Each <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceAttribute"/> in
    /// a <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecord"/> holds its content in a
    /// Service Element.
    /// </para>
    ...
    /// e.g. as used by the 
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.AttributeIds.UniversalAttributeId.ProtocolDescriptorList"/>
    /// attribute.
    /// </para>
    /// <para>The type that an element is holding can be accessed with the 
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.ElementTypeDescriptor"/> and 
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.ElementType"/> properties which
    /// are of type <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor"/> and
    /// <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementType"/> respectively, the former being 
    /// the &#x2018;major&#x2019; type e.g. 
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor.UnsignedInteger"/>, and
    /// the latter the &#x2018;minor&#x2019; type e.g. 
    /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.UInt16"/>.
    /// </para>
    /// <para>The element's value can be accessed in various ways, either directly 
    /// in its internal form through its <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.Value"/>
    ...
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsElementArray"/>,
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUuid"/>, 
    ...
    /// <list type="table">
    /// <listheader><term><see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementType"/></term>
    ...
    ///
    /// <item><term><c>Uuid16</c></term><description>Via <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUuid"/>, or as <see cref="T:System.UInt16"/></description></item>
    /// <item><term><c>Uuid32</c></term><description>Via <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUuid"/>, or as <see cref="T:System.UInt16"/></description></item>
    /// <item><term><c>Uuid128</c></term><description>Via <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUuid"/></description></item>
    /// 
    /// <item><term><c>TextString</c></term><description>With 
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsString(System.Text.Encoding)"/>
    /// or <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsStringUtf8"/> etc.
    /// The underlying value can be an array of bytes, or as a <see cref="T:System.String"/>
    /// the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser"/> will set an
    ...
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsElementArray"/> or
    /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsElementList"/>
    /// </description></item>
    /// <item><term><c>ElementSequence</c></term><description>-"-</description></item>
    ///
    /// <item><term><c>Url</c></term><description>Via <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUri"/>,
    ...
    /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.Value"/> property will have
    /// to be used e.g.
    /// <code lang="C#">
...
#pragma warning disable 618
    ...
    */
#endif
        /// <overloads>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/> class.
        /// </overloads>
        /// -
        /// <summary>
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/> class.
        ...
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.UInt8"/> then the object
        /// passed in must be a <see cref="T:System.Byte"/>, if the element type is
        /// <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.TextString"/> then the object
        /// must either be a <see cref="T:System.String"/> or the string encoded as 
        /// an array of <see cref="T:System.Byte"/>, 
        /// and if the element type is <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.Uuid16"/>
        /// then the object passed in must be a <see cref="T:System.UInt16"/>,
        /// etc.
        /// For the full list of types see the class level documentation 
        /// (<see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>).
        /// </para>
        /// <para>For numerical element types the 
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.CreateNumericalServiceElement(NXTLib.BluetoothWrapper.Bluetooth.ElementType,System.Object)"/>
        /// factory method will accept any integer type and attempt to convert it to the 
        /// required type before creating the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>,
        /// for example for element type <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.UInt8"/> 
...
#pragma warning restore 618
    ...
    */
        ...
        /// <summary>
        /// Obsolete, use <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.#ctor(NXTLib.BluetoothWrapper.Bluetooth.ElementType,System.Object)"/> instead.
        /// Initializes a new instance of the <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Create an instance of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>
        /// but internally converting the numeric value to the required type.
        /// </summary>
        /// -
        /// <remarks>
        /// <para>As noted in the constructor documentation 
        /// (<see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.#ctor(NXTLib.BluetoothWrapper.Bluetooth.ElementType,System.Object)"/>)
        ...
        /// to the constructor will fail for element types <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.UInt8"/>
        ...
        ///    at NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.ConvertNumericalValue(ElementType elementType, Object value)
        ///    --- End of inner exception stack trace ---
        ///    at NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.ConvertNumericalValue(ElementType elementType, Object value)
        ///    at NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.CreateNumericalServiceElement(ElementType elementType, Object value)
        ...
        /// <summary>
        /// Gets the type of the element as an <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementType"/>.
        /// </summary>
        ...
        /// as an <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor"/>.
        /// </summary>
        ...
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsElementList"/>, 
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUri"/>, 
        /// <see cref="M:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.GetValueAsUuid"/>, etc.
        /// </remarks>
        public Object Value
        {
            [System.Diagnostics.DebuggerStepThrough]
        ...
        /// <summary>
        /// Gets the value as a list of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>.
        /// </summary>
        /// -
        ...
        /// <c>ElementType</c>.<see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.ElementSequence"/>
        /// or <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.ElementAlternative"/>.
        /// </exception>
#if CODE_ANALYSIS
        ...
        /// <summary>
        /// Gets the value as a array of <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement"/>.
        /// </summary>
        /// -
        ...
        /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser.LazyUrlCreation">ServiceRecordParser.LazyUrlCreation</see>
        ...
        /// element's <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceElement.Value"/>
        /// property and expect one of the three types.  When created by the 
        /// parser it will be of type <see cref="T:System.String"/> unless 
        /// <see cref="P:NXTLib.BluetoothWrapper.Bluetooth.ServiceRecordParser.LazyUrlCreation"/>
        /// is set.
        /// </para>
        /// </remarks>
        /// -
        /// <exception cref="T:System.InvalidOperationException">
        /// The service element is not of type
        /// <c>ElementType</c>.<see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.Url"/>.
        /// </exception>
#if CODE_ANALYSIS
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate")]
#endif
        ...
        /// <exception cref="T:System.InvalidOperationException">
        /// The service element is not of type
        /// <c>ElementType</c>.<see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementType.Uuid128"/>.
        /// </exception>
#if CODE_ANALYSIS
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1024:UsePropertiesWhereAppropriate")]
#endif
        ...
        /// <summary>
        /// Get the value of the <see cref="F:NXTLib.BluetoothWrapper.Bluetooth.ElementTypeDescriptor.TextString"/>,
