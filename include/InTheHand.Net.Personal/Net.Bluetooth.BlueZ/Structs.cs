...
//
// NXTLib.BluetoothWrapper.Bluetooth.BlueZ.Structs
// 
...
#pragma warning disable 649 // Field '...' is never assigned to, and will always have its default value ...
        ...
        internal struct hci_version
        {
                ...
                : this()
            {
                ...
                NXTLib.BluetoothWrapper.Bluetooth.Widcomm.DEV_VER_INFO.SetManufacturerAndVersionsToUnknown(
        ...
        internal struct uuid_t
        {
            ...
            internal uuid_t(Guid uuid)
            {
                ...
                var netOrder = NXTLib.BluetoothWrapper.Sockets.BluetoothListener.HostToNetworkOrder(uuid);
