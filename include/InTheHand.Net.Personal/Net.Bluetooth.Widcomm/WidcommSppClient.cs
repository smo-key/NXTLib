...
//
// NXTLib.BluetoothWrapper.Widcomm.WidcommSppClient
// 
...
using NXTLib.BluetoothWrapper.Ports;
...
namespace NXTLib.BluetoothWrapper.Bluetooth.Widcomm
{
    internal sealed partial class WidcommSppClient : WidcommSerialPort
    {
        ...
        internal string CreatePort(BluetoothAddress addr)
        {
            ...
            if (!signalled)
                throw WidcommSocketExceptions.Create_NoResultCode(
        ...
        private static class NativeMethods
        {
            ...
            [DllImport(WidcommRfcommPort.NativeBits.WidcommDll)]
