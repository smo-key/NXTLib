...
using AR_Inquiry = NXTLib.BluetoothWrapper.AsyncResult<System.Collections.Generic.List<NXTLib.BluetoothWrapper.Bluetooth.Factory.IBluetoothDeviceInfo>>;
...
namespace NXTLib.BluetoothWrapper.Bluetooth.Widcomm
{
    internal sealed class WidcommBtInterface : IDisposable
    {
        ...
        /// </remarks>
        /// -
        /// <returns>A <see cref="T:NXTLib.BluetoothWrapper.Bluetooth.Widcomm.WBtRc"/> value.</returns>
