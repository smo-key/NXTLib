...
namespace NXTLib.BluetoothWrapper.Bluetooth.BlueSoleil
{
    class BluesoleilSecurity : IBluetoothSecurity
    {
        ...
        //----
        bool IBluetoothSecurity.SetPin(NXTLib.BluetoothWrapper.BluetoothAddress device, string pin)
        {
            throw new NotImplementedException();
        }

        bool IBluetoothSecurity.RevokePin(NXTLib.BluetoothWrapper.BluetoothAddress device)
        {
            throw new NotImplementedException();
        }
