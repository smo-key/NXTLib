...
//
// NXTLib.BluetoothWrapper.Sockets.IrDASocketOptionName
// 
...
namespace NXTLib.BluetoothWrapper.Sockets
{
    ...
    /// cref="F:NXTLib.BluetoothWrapper.Sockets.IrDASocketOptionLevel.IrLmp"/>; 
    /// see the examples below.
    /// <para><b>New in v1.5.51015</b></para>
    /// </remarks>
    /// <example><para>For instance, where <c>cli</c> is an instance of 
    /// <see cref="T:NXTLib.BluetoothWrapper.Sockets.IrDAClient"/>.</para>
	...
	public static class IrDASocketOptionName
	{
        ...
        /// (<see cref="F:NXTLib.BluetoothWrapper.Sockets.IrDASocketOptionName.IrLptMode"/>).  
